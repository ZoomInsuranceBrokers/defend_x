        ...
        <ul class="navbar-nav navbar-nav-right">
            <li class="nav-item dropdown d-none d-lg-block">
                <a class="nav-link btn btn-success create-new-button" id="createbuttonDropdown"
                    data-bs-toggle="dropdown" aria-expanded="false" href="#">+ Create</a>
                <div class="dropdown-menu dropdown-menu-end navbar-dropdown preview-list"
                    ...
                    <a class="dropdown-item preview-item">
                        ...
                        <div class="preview-item-content">
                            <p class="preview-subject ellipsis mb-1">New Company</p>
                        </div>
                    </a>
                    <div class="dropdown-divider"></div>
                    <a class="dropdown-item preview-item">
                        ...
                        <div class="preview-item-content">
                            <p class="preview-subject ellipsis mb-1">New User</p>
                        </div>
                    </a>
                    <div class="dropdown-divider"></div>
                    <a class="dropdown-item preview-item">
                ...
                <div class="dropdown-menu dropdown-menu-end navbar-dropdown preview-list"
                    ...
                    <a class="dropdown-item preview-item">
                        ...
                        <form action="{{ route('logout') }}" method="POST">
                            @csrf
                            <div class="preview-item-content" onclick="this.closest('form').submit()">
